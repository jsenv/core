System.register([__v__("/js/new_stylesheet.nomodule.js"), __v__("/js/inline_content.nomodule.js")], function (_export, _context) {
  ...
  return {
    setters: [function (_srcPluginsTranspilationBabelNew_stylesheetClientNew_stylesheetJs) {}, function (_srcPluginsInlineClientInline_contentJs) {
      InlineContent = _srcPluginsInlineClientInline_contentJs.InlineContent;
    }],
    execute: function () {
