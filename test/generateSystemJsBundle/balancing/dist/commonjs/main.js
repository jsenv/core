(function () {
  ...
  globalThis.System.register([], function (_export, _context) {
    var execute = _async(function () {
      ...
      var scriptSrc = "./".concat(compileId, "/").concat(entryPointName, ".js");
      return _await(_context.import(scriptSrc), function (namespace) {
        _export(namespace);
      });
    });
