      ...
      class JsenvErrorOverlay extends HTMLElement {
        constructor(exception) {
          ...
          const renderException = () => {
            ...
            const preferCause = cause.code === "MODULE_NOT_FOUND" || cause.code === "PROTOCOL_NOT_SUPPORTED" || cause.code === "PARSE_ERROR";
            ...
            root.querySelector(".text").innerHTML = stringifyStack({
              ...
              name: cause.parseErrorSourceType === "css" ? "CSSSyntaxError" : dataToRender.name,
