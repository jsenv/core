...
const LIGHT_ACCENT_ATTRIBUTE = "data-light-accent";
const VERY_LIGHT_ACCENT_ATTRIBUTE = "data-very-light-accent";
const DARK_CONTRAST_ATTRIBUTE = "data-dark-contrast";
 ...
 *
 * ## `data-light-accent` (set when OKLCH L > 0.5)
 ...
 *
 * ## `data-very-light-accent` (set when OKLCH L > 0.92)
 ...
 *   page backgrounds.
 *
 * ## `data-dark-contrast` (set when OKLCH L > 0.65)
 *   The best contrasting color against the accent is dark (black). Use to
 *   render checkmarks, icons, or text in a dark color instead of white.
 *
 ...
 */
export const useAccentAttributes = (
  ref,
  deps = [],
