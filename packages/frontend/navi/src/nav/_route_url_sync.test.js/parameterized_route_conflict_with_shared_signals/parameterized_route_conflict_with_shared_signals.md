# [parameterized route conflict with shared signals](../../route_url_sync.test.js#L299)
...
```js
{
  ...
  "panel_route_incorrectly_called": true,
  "isochrone_route_incorrectly_called": true,
  "expected_route": "MAP_ROUTE",
  "expected_url_pattern": "/map?zoom=25",
  "actual_route": "MAP_ISOCHRONE_ROUTE",
