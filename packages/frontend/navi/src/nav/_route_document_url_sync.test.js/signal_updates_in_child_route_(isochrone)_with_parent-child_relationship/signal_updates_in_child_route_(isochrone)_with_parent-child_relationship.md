    ...
    "redirect_calls": [
      {
        ...
        "url": "http://127.0.0.1/map/isochrone?zone=nice&iso_lon=10&walk"
      }
    ]
  },
  "scenario3_minute_45": {
    ...
    "redirect_calls": [
      {
        ...
        "url": "http://127.0.0.1/map/isochrone?zone=nice&iso_lon=10&walk&walk_minute=45"
      },
      {
        "route": "ISOCHRONE_COMPARE_ROUTE",
        "params": {
    ...
    "redirect_calls": [
      {
        ...
        "url": "http://127.0.0.1/map/isochrone?zone=nice&iso_lon=10&walk_minute=45"
      }
    ]
  },
  "scenario5_minute_60": {
    ...
    "redirect_calls": [
      {
        ...
        "url": "http://127.0.0.1/map/isochrone?zone=nice&iso_lon=10&walk_minute=60"
      }
    ]
  },
  "url_progression": [
    "http://127.0.0.1/map/isochrone?zone=nice&iso_lon=10",
