...
export const getDefaultStyles = (elementString) => {
  ...
  const parsedElement = unstyledElement.shadowRoot.querySelector("style + *");
  ...
  const tagName = parsedElement.tagName.toLowerCase();
  const actualElement = unstyledElement.shadowRoot.querySelector(tagName);
