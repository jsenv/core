...
function $(l) {
  (8 & l.__g || !(l.__g |= 8) || !t$2.push(l) || r$2++) && i$2 == n$1.debounceRendering || ((i$2 = n$1.debounceRendering) || queueMicrotask)(x$2);
}
function x$2() {
...
function C$1(n, l, u, t, i, r, f, e, o, c, s, a) {
  var v,
    ...
    k = t && t.__k || p$2,
    m = l.length;
  for (o = j$1(u, l, k, o, m), v = 0; v < m; v++) null != (w = u.__k[v]) && (y = -1 == w.__i ? h$3 : k[w.__i] || h$3, w.__i = v, g = q$2(n, w, y, i, r, f, e, o, c, s, a), d = w.__e, w.ref && y.ref != w.ref && (y.ref && B$1(y.ref, null, w), s.push(w.ref, w.__c || d, w)), null == _ && null != d && (_ = d), (b = !!(4 & w.__u)) || y.__k === w.__k ? o = A$1(w, o, n, b) : "function" == typeof w.type && void 0 !== g ? o = g : d && (o = d.nextSibling), w.__u &= -7);
  return u.__e = _, o;
}
function j$1(n, l, u, t, i) {
  var r,
    ...
    a = s,
    h = 0;
  for (n.__k = new Array(i), r = 0; r < i; r++) null != (f = l[r]) && "boolean" != typeof f && "function" != typeof f ? (o = r + h, (f = n.__k[r] = "string" == typeof f || "number" == typeof f || "bigint" == typeof f || f.constructor == String ? g$3(null, f, null, null, null) : v$3(f) ? g$3(k$1, {
    children: f
  }, null, null, null) : null == f.constructor && f.__b > 0 ? g$3(f.type, f.props, f.key, f.ref ? f.ref : null, f.__v) : f).__ = n, f.__b = n.__b + 1, e = null, -1 != (c = f.__i = I(f, u, o, a)) && (a--, (e = u[c]) && (e.__u |= 2)), null == e || null == e.__v ? (-1 == c && (i > s ? h-- : i < s && h++), "function" != typeof f.type && (f.__u |= 4)) : c != o && (c == o - 1 ? h-- : c == o + 1 ? h++ : (c > o ? h-- : h++, f.__u |= 4))) : n.__k[r] = null;
  if (a) for (r = 0; r < s; r++) null != (e = u[r]) && 0 == (2 & e.__u) && (e.__e == t && (t = M(e)), D$1(e, e));
  return t;
}
...
function q$2(l, u, t, i, r, f, e, o, c, s, a) {
  ...
  n: if ("function" == typeof F) try {
    if (S = u.props, $ = "prototype" in F && F.prototype.render, x = (h = F.contextType) && i[h.__c], j = h ? x ? x.props.value : h.__ : i, t.__c ? 2 & (p = u.__c = t.__c).__g && (p.__g |= 1, M = !0) : ($ ? u.__c = p = new F(S, j) : (u.__c = p = new m$2(S, j), p.constructor = F, p.render = E$1), x && x.sub(p), p.props = S, p.state || (p.state = {}), p.context = j, p.__n = i, y = !0, p.__g |= 8, p.__h = [], p._sb = []), $ && null == p.__s && (p.__s = p.state), $ && null != F.getDerivedStateFromProps && (p.__s == p.state && (p.__s = w$3({}, p.__s)), w$3(p.__s, F.getDerivedStateFromProps(S, p.__s))), _ = p.props, g = p.state, p.__v = u, y) $ && null == F.getDerivedStateFromProps && null != p.componentWillMount && p.componentWillMount(), $ && null != p.componentDidMount && p.__h.push(p.componentDidMount);else {
    ...
    p.state = p.__s, null != p.getChildContext && (i = w$3({}, i, p.getChildContext())), $ && !y && null != p.getSnapshotBeforeUpdate && (b = p.getSnapshotBeforeUpdate(_, g)), O = h, null != h && h.type === k$1 && null == h.key && (O = V(h.props.children)), o = C$1(l, v$3(O) ? O : [O], u, t, i, r, f, e, o, c, s, a), u.__u &= -161, p.__h.length && e.push(p), M && (p.__g &= -4);
  } catch (l) {
...
function P(l, u, t) {
  for (var i = 0; i < t.length; i++) B$1(t[i], t[++i], t[++i]);
...
function V(n) {
  return "object" != typeof n || null == n || n.__b && n.__b > 0 ? n : v$3(n) ? n.map(V) : w$3({}, n);
}
function z$1(l, u, t, i, r, f, e, o, c, s) {
  ...
  if (null == x) S === $ || o && l.data == $ || (l.data = $);else {
    ...
    if (p) o || w && (p.__html == w.__html || p.__html == l.innerHTML) || (l.innerHTML = p.__html), u.__k = [];else if (w && (l.innerHTML = ""), C$1("template" == x ? l.content : l, v$3(_) ? _ : [_], u, t, i, "foreignObject" == x ? "http://www.w3.org/1999/xhtml" : r, f, e, f ? f[0] : t.__k && M(t, 0), o, c, s), null != f) for (a = f.length; a--;) d$3(f[a]);
...
function D$1(l, u, t) {
  var i, r;
  if (n$1.unmount && n$1.unmount(l), (i = l.ref) && (i.current && i.current != l.__e || B$1(i, null, u)), null != (i = l.__c)) {
...
function F$2(l, u) {
  var t, i, r, f;
  u == document && (u = document.documentElement), n$1.__ && n$1.__(l, u), i = (t = !!(l && 32 & l.__u)) ? null : u.__k, l = u.__k = _$2(k$1, null, [l]), r = [], f = [], q$2(u, l, i || h$3, h$3, u.namespaceURI, i ? null : u.firstChild ? y$3.call(u.childNodes) : null, r, i ? i.__e : u.firstChild, t, f, u.ownerDocument), P(r, l, f);
}
n$1 = {
...
}, m$2.prototype.render = k$1, t$2 = [], r$2 = 0, f$1 = function (n, l) {
  return n.__v.__b - l.__v.__b;
}, e$2 = /(PointerCapture)$|Capture$/i, o$3 = 0, c$2 = T(false), s$2 = T(true);
...
function y({
  ...
  const [n, r] = q$1(() => {
    ...
    const o = g$1(() => {
      ...
      r = g$1(() => !Array.isArray(o.value) && !u$3(o.value)),
      f = j(function () {
        this.N = F;
        if (r.value) {
          const i = o.value;
...
m$2.prototype.shouldComponentUpdate = function (t, i) {
...
export { A, F$1 as F, F$2 as F$1, O, a, b$2 as b, h$2 as h, j, k$1 as k, u, useSignal };
