...
const r = String.raw,
  e = r(_templateObject || (_templateObject = _taggedTemplateLiteral(["p{Emoji}(?:p{EMod}|[\uDB40\uDC20-\uDB40\uDC7E]+\uDB40\uDC7F|\uFE0F?\u20E3?)"], ["\\p{Emoji}(?:\\p{EMod}|[\\u{E0020}-\\u{E007E}]+\\u{E007F}|\\uFE0F?\\u20E3?)"])));
const emojiRegex = () => new RegExp(r(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["p{RI}{2}|(?![#*d](?!\uFE0F?\u20E3))", "(?:\u200D", ")*"], ["\\p{RI}{2}|(?![#*\\d](?!\\uFE0F?\\u20E3))", "(?:\\u200D", ")*"])), e, e), 'gu');
