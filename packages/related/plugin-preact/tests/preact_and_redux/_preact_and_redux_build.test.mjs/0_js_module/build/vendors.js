...
function getContext() {
  ...
  let realContext = contextMap.get(K);
  if (!realContext) {
    realContext = K(
      null
    );
    contextMap.set(K, realContext);
  }
  return realContext;
}
...
export { F$1 as F, Provider_default, _, combineReducers, compose, createStore, u, useDispatch, useSelector };