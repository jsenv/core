...
export const takeCoverageSnapshots = async (
  testPlanResult,
  {
    testOutputDirectoryUrl,
    coverageDirectoryUrl = new URL("./.coverage/", testOutputDirectoryUrl),
    screenshotDirectoryUrl = new URL("./screenshots/", testOutputDirectoryUrl),
    snapshotDirectoryUrl = new URL("./snapshots/", testOutputDirectoryUrl),
    fileRelativeUrls,
  },
) => {
  ...
  for (const fileRelativeUrl of fileRelativeUrls) {
    ...
    // screenshot
    if (screenshotDirectoryUrl && !process.env.CI) {
