...
function stripAnsi$1(string) {
	...
	// Even though the regex is globalThis, we don't need to reset the `.lastIndex`
...
var emojiRegex = /*@__PURE__*/getDefaultExportFromCjs$1(emojiRegexExports);
...
(function(root) {
			...
			if (freeGlobal.globalThis === freeGlobal || freeGlobal.window === freeGlobal) {
				root = freeGlobal;
			}
...
var __jsenv_default_import__ = /*@__PURE__*/getDefaultExportFromCjs(heExports);

export { __jsenv_default_import__, ansiRegex$1 as ansiRegex, stringWidth, stripAnsi };
