...
![img](buffer_from()_vs_buffer_from(a)/throw.svg)
...
![img](buffer_from(a)_vs_buffer_from()/throw.svg)
...
![img](buffer_without_diff_are_collapsed/throw.svg)
...
![img](same_length_buffer_diff_at_the_end/throw.svg)
...
![img](same_length_buffer_diff_at_start/throw.svg)
...
![img](same_length_buffer_diff_at_middle/throw.svg)
...
![img](same_length_buffer_diff_start__middle__end/throw.svg)
...
![img](buffer_vs_string/throw.svg)
...
![img](buffer_from_vs_uint8array_from/throw.svg)
...
![img](uint8array_vs_array/throw.svg)
