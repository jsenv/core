...
![img](named_symbol()_property_added/throw.svg)
...
![img](named_symbol()_property_removed/throw.svg)
...
![img](symbol_for()_property_value_modified/throw.svg)
...
![img](symbol_for()_property_no_diff/throw.svg)
...
![img](named_symbol()_property_value_modified/throw.svg)
...
![img](named_symbol()_property_no_diff/throw.svg)
...
![img](anonymous_symbol()_property_value_modified/throw.svg)
...
![img](symbol_iterator_property_value_modified/throw.svg)
...
![img](symbol_tostringtag_property_value_modified/throw.svg)
...
![img](well_known_symbol_diff/throw.svg)
...
![img](symbol()_description_modified/throw.svg)
...
![img](symbol_for()_key_modified/throw.svg)
...
![img](named_symbol()_vs_anonymous_symbol/throw.svg)
...
![img](anonymous_symbol_vs_named_symbol()/throw.svg)
...
![img](named_symbol()_vs_symbol_for()/throw.svg)
...
![img](symbol_for()_vs_named_symbol()/throw.svg)
...
![img](symbol_diff_comes_first/throw.svg)
