...
var fetchAndEval = _async$9(function (url) {
  return _await$a(fetchUrl(url), function (response) {
    return function () {
      if (response.status >= 200 && response.status <= 299) {
        return _await$a(response.text(), function (text) {
...
var getRessourceTrace = function getRessourceTrace(_ref3) {
  var urlContext = _ref3.urlContext,
      url = _ref3.url,
      importerUrl = _ref3.importerUrl,
      type = _ref3.type,
      _ref3$notFound = _ref3.notFound,
      notFound = _ref3$notFound === void 0 ? false : _ref3$notFound;
  var namings = {
    js_module: {
  ...
  if (notFound) {
    return _objectSpread2(_objectSpread2({}, importerUrl ? _defineProperty({}, namings.declaration, urlContext.asSourceRelativeUrl(importerUrl)) : {}), {}, {
  ...
  return _objectSpread2({
    file: urlContext.asSourceRelativeUrl(url)
  }, importerUrl ? _defineProperty({}, namings.usage, urlContext.asSourceRelativeUrl(importerUrl)) : {});
};
...
var getRessourceResponseError = _async$8(function (_ref) {
  var _exit = false;
  var urlContext = _ref.urlContext,
      contentTypeExpected = _ref.contentTypeExpected,
      type = _ref.type,
      url = _ref.url,
  ...
  if (response.status === 404) {
    return new Error(createDetailedMessage("file cannot be found", _objectSpread2({}, getRessourceTrace({
  ...
  return _invoke$6(function () {
    ...
    return _exit ? _result : response.status < 200 || response.status >= 300 ? new Error(createDetailedMessage("file response status is unexpected", _objectSpread2({
      "status": response.status,
      ...
      importerUrl: importerUrl,
      type: type
    })))) : contentType !== contentTypeExpected ? new Error(createDetailedMessage("Failed to load ressource: Expected \"".concat(contentTypeExpected, "\" MIME type but the server responded with a MIME type of \"").concat(contentType, "\""), _objectSpread2(_objectSpread2({}, getRessourceTrace({
      urlContext: urlContext,
      url: url,
      importerUrl: importerUrl,
      type: type
    })), contentTypeExpected === "application/javascript" && type === "js_module" ? {
...
var initHtmlSupervisor = function initHtmlSupervisor() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      errorTransformer = _ref.errorTransformer;

  var scriptExecutionResults = {};
  var urlContext = createUrlContext(inferContextFrom({
    url: window.location.href
  }));
  var collectCalled = false;
  var pendingExecutionCount = 0;
  var resolveScriptExecutionsPromise;
  var scriptExecutionsPromise = new Promise(function (resolve) {
    resolveScriptExecutionsPromise = resolve;
  });

  var onExecutionStart = function onExecutionStart(name) {
  ...
  var onExecutionSettled = function onExecutionSettled(name, executionResult) {
  ...
  var addExecution = _async$7(function (_ref2) {
    var src = _ref2.src,
        currentScript = _ref2.currentScript,
        promise = _ref2.promise,
        _ref2$improveErrorWit = _ref2.improveErrorWithFetch,
        improveErrorWithFetch = _ref2$improveErrorWit === void 0 ? false : _ref2$improveErrorWit;
        ...
        return _invoke$5(function () {
          if (errorTransformer) {
            return _continueIgnored(_catch$3(function () {
              return _await$8(errorTransformer(e), function (_errorTransformer) {
                executionResult.error = _errorTransformer;
              });
            }, _empty));
          }
        }, function () {
  ...
  var collectScriptResults = _async$7(function () {
    collectCalled = true;
    return _invoke$5(function () {
      if (pendingExecutionCount === 0) {
        resolveScriptExecutionsPromise();
      } else {
        return _awaitIgnored(scriptExecutionsPromise);
      }
    }, function () {
      var status = "completed";
      var exceptionSource = "";
      Object.keys(scriptExecutionResults).forEach(function (key) {
        var scriptExecutionResult = scriptExecutionResults[key];
  ...
  return {
    ...
    collectScriptResults: collectScriptResults
  };
};
...
var onExecutionError = function onExecutionError(executionResult, _ref4) {
  var currentScript = _ref4.currentScript,
...
var remapCallSite = _async$6(function (callSite, _ref) {
  ...
  return _invoke$4(function () {
    if (source) {
      ...
      return _await$7(remapSourcePosition({
        source: source,
        line: line,
        column: column,
    ...
    return _invoke$4(function () {
      if (callSite.isEval()) {
        ...
        return _invoke$4(function () {
          if (origin) {
            var callSiteClone = cloneCallSite(callSite);
            return _await$7(remapEvalOrigin(origin, {
              resolveFile: resolveFile,
              urlToSourcemapConsumer: urlToSourcemapConsumer,
              readErrorStack: readErrorStack,
              onFailure: onFailure
...
var remapEvalOrigin = _async$6(function (origin, _ref3) {
  ...
  return _invoke$4(function () {
    ...
    return _invoke$4(function () {
      if (nestedEvalMatch) {
        return _await$7(remapEvalOrigin(nestedEvalMatch[2], {
          resolveFile: resolveFile,
          urlToSourcemapConsumer: urlToSourcemapConsumer,
          onFailure: onFailure
        }), function (originalEvalOrigin) {
...
var remapSourcePosition = _async$6(function (_ref4) {
  ...
  return url ? _await$7(urlToSourcemapConsumer(url), function (sourceMapConsumer) {
...
var remapStack = _async$5(function (_ref) {
    ...
    return stackTraceFileUrl.startsWith("node:") ? null : _catch$2(function () {
      ...
      return _continue$1(_catch$2(function () {
        ...
        return _invoke$3(function () {
          ...
          return _await$6(Promise.all(sourceMap.sources.map(_async$5(function (source, index) {
    ...
    return _invoke$2(function () {
      if (promise) {
        return _catch$1(function () {
          return _await$5(promise, function (originalCallsites) {
...
var installBrowserErrorStackRemapping = function installBrowserErrorStackRemapping() {
  ...
  return installErrorStackRemapping(_objectSpread2({
    fetchFile: _async$3(function (url) {
      ...
      return _await$4(window.fetch(url, {
        ...
        return _await$4(response.text(), function (_text) {
          return {
            status: response.status,
            url: response.url,
            statusText: response.statusText,
...
var createBrowserSystem = function createBrowserSystem(_ref) {
  ...
  browserSystem.instantiate = _async$2(function (url, importerUrl) {
    var _exit = false;
    ...
    return _invoke$1(function () {
      if (importType === "json") {
        return _await$2(instantiateAsJsonModule(urlWithoutImportType, {
      ...
      return _invoke$1(function () {
        if (importType === "css") {
          return _await$2(instantiateAsCssModule(urlWithoutImportType, {
            browserSystem: browserSystem,
            importerUrl: importerUrl,
            urlContext: urlContext,
            fetchSource: fetchSource
        ...
        return _exit2 ? _result2 : _catch(function () {
          return _await$2(instantiate.call(_this, url, importerUrl), function (registration) {
            if (!registration) {
          ...
          return _continue(_catch(function () {
            return _await$2(fetchSource(url), function (_fetchSource) {
            ...
            return _await$2(getRessourceResponseError({
              urlContext: urlContext,
              contentTypeExpected: "application/javascript",
              type: "js_module",
              url: url,
...
var instantiateAsJsonModule = _async$2(function (url, _ref2) {
  var browserSystem = _ref2.browserSystem,
      fetchSource = _ref2.fetchSource;
  return _await$2(fetchSource(url, {
    contentTypeExpected: "application/json"
  }), function (response) {
    return _await$2(response.json(), function (json) {
...
var instantiateAsCssModule = _async$2(function (url, _ref3) {
  ...
  return _await$2(fetchSource(url, {
    ...
    */
    ...
    return _await$2(response.text(), function (cssText) {
...
var createBrowserClient = _async$1(function (_ref) {
  var urlContext = _ref.urlContext,
      importDefaultExtension = _ref.importDefaultExtension;
  ...
  return _invoke(function () {
    if (importmapScript) {
      ...
      return _invoke(function () {
        if (importmapScript.src) {
          ...
          return _await$1(fetchSource(importMapUrl, {
            contentTypeExpected: "application/importmap+json"
          }), function (importmapFileResponse) {
            var _temp = importmapFileResponse.status === 404;

            return _await$1(_temp ? {} : importmapFileResponse.json(), function (_importmapFileRespons) {
    ...
    return _await$1(createImportResolverForImportmap({
      ...
      return _await$1(createBrowserSystem({
        urlContext: urlContext,
        fetchSource: fetchSource,
...
var getCompileProfilePromise = memoize(_async(function () {
  ...
  return _await(fetchUrl("".concat(compileServerOrigin, "/__jsenv_compile_profile__")), function (compileServerResponse) {
    return _await(compileServerResponse.json());
  });
}));
...
var getErrorTransformer = memoize(_async(function () {
  return Error.captureStackTrace ? _call(getCompileProfilePromise, function (_ref) {
    var errorStackRemapping = _ref.errorStackRemapping,
        sourcemapMainFileRelativeUrl = _ref.sourcemapMainFileRelativeUrl,
        sourcemapMappingFileRelativeUrl = _ref.sourcemapMappingFileRelativeUrl;
...
var getBrowserClient = memoize(function () {
  return _call(getCompileProfilePromise, function (_ref2) {
    var jsenvDirectoryRelativeUrl = _ref2.jsenvDirectoryRelativeUrl,
        importDefaultExtension = _ref2.importDefaultExtension;
    var urlContext = createUrlContext(inferContextFrom({
...
var htmlSupervisor = initHtmlSupervisor({
  errorTransformer: function (e) {
    return _call(getErrorTransformer, function (transformer) {
...
var superviseScriptTypeModule = function superviseScriptTypeModule(_ref3) {
  var src = _ref3.src;
  htmlSupervisor.addExecution({
    ...
    src: src,
    promise: function () {
      return _call(getBrowserClient, function (browserClient) {
...
//# sourceMappingURL=html_supervisor_classic.js.map