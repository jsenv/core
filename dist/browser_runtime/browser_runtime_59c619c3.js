...
var remapCallSite = _async$b(function (callSite, _ref) {
  var _exit = false;
  ...
  return _invoke$6(function () {
    if (source) {
      ...
      return _await$b(remapSourcePosition({
        source: source,
        line: line,
        column: column,
    ...
    return _invoke$6(function () {
      if (callSite.isEval()) {
        ...
        return _invoke$6(function () {
          if (origin) {
            var callSiteClone = cloneCallSite(callSite);
            return _await$b(remapEvalOrigin(origin, {
              resolveFile: resolveFile,
              urlToSourcemapConsumer: urlToSourcemapConsumer,
              readErrorStack: readErrorStack,
              onFailure: onFailure
...
var remapEvalOrigin = _async$b(function (origin, _ref3) {
  var _exit3 = false;
  ...
  return _invoke$6(function () {
    ...
    return _invoke$6(function () {
      if (nestedEvalMatch) {
        return _await$b(remapEvalOrigin(nestedEvalMatch[2], {
          resolveFile: resolveFile,
          urlToSourcemapConsumer: urlToSourcemapConsumer,
          onFailure: onFailure
        }), function (originalEvalOrigin) {
...
var remapSourcePosition = _async$b(function (_ref4) {
...
var getOriginalCallsites = _async$a(function (_ref) {
  var stack = _ref.stack,
      ...
      readErrorStack = _ref.readErrorStack,
      onFailure = _ref.onFailure;
  var urlToSourcemapConsumer = memoizeByFirstArgStringValue(_async$a(function (stackTraceFileUrl) {
    var _exit = false;
    return stackTraceFileUrl.startsWith("node:") ? null : _catch$4(function () {
      var text;
      return _continue$2(_catch$4(function () {
        return _await$a(fetchFile(stackTraceFileUrl), function (fileResponse) {
        ...
        return _invoke$5(function () {
          if (jsSourcemapUrl.startsWith("data:")) {
            ...
            return _catch$4(function () {
              return _await$a(fetchFile(sourcemapUrl), function (sourcemapResponse) {
                var _exit3 = false;
                ...
                return _invoke$5(function () {
                  ...
                  return _exit3 ? _result3 : _await$a(sourcemapResponse.text(), function (_sourcemapResponse$te2) {
          ...
          return _await$a(Promise.all(sourceMap.sources.map(_async$a(function (source, index) {
            if (index in sourcesContent) return;
            var sourcemapSourceUrl = resolveFile(source, sourcemapUrl, {
              type: "source"
            });
            return _catch$4(function () {
              return _await$a(fetchFile(sourcemapSourceUrl), function (sourceResponse) {
                var _exit4 = false;
                ...
                return _invoke$5(function () {
                  ...
                  return _exit4 ? _result6 : _await$a(sourceResponse.text(), function (sourceString) {
...
var installErrorStackRemapping = function installErrorStackRemapping(_ref) {
  ...
  var getErrorOriginalStackString = _async$9(function (error) {
    var _exit = false;
    ...
    return _invoke$4(function () {
      if (promise) {
        return _catch$3(function () {
          return _await$9(promise, function (originalCallsites) {
...
var installBrowserErrorStackRemapping = function installBrowserErrorStackRemapping() {
  ...
  return installErrorStackRemapping(_objectSpread2({
    fetchFile: _async$8(function (url) {
      ...
      return _await$8(window.fetch(url, {
...
var fetchUsingXHR = _async$7(function (url) {
  ...
  xhr.send(body);
  return _await$7(headersPromise, function () {
    ...
    var readBody = function readBody() {
      return _await$7(bodyPromise, function () {
...
var fetchNative = _async$6(function (url) {
  ...
  return _await$6(window.fetch(url, _objectSpread2({
    mode: mode
...
var fetchAndEvalUsingFetch = _async$5(function (url) {
  return _await$5(fetchUrl(url), function (response) {
    return function () {
...
var getJavaScriptModuleResponseError = _async$4(function (response, _ref) {
  ...
  return _invoke$3(function () {
    if (response.status === 500 && contentType === "application/json") {
      return _await$4(response.json(), function (bodyAsJson) {
...
var measureAsyncFnPerf = performance$1 ? _async$3(function (fn, name) {
  ...
  browserSystem.instantiate = _async$2(function (url, importerUrl) {
    ...
    return _invoke$2(function () {
      ...
      return _invoke$2(function () {
        ...
        return _exit2 ? _result2 : _catch$2(function () {
          ...
          return _await$2(createDetailedInstantiateError({
            instantiateError: e,
            url: url,
            importerUrl: importerUrl,
            compileServerOrigin: compileServerOrigin,
...
var createDetailedInstantiateError = _async$2(function (_ref6) {
  var _exit3 = false;
  ...
  return _continue$1(_catch$2(function () {
    ...
    return _exit3 ? _result3 : _await$2(getJavaScriptModuleResponseError(response, {
      url: url,
      importerUrl: importerUrl,
      compileServerOrigin: compileServerOrigin,
      compileDirectoryRelativeUrl: compileDirectoryRelativeUrl
...
var createBrowserRuntime = _async$1(function (_ref) {
  ...
  var fetchJson = _async$1(function (url) {
    return _await$1(fetchSource(url, {
      contentTypeExpected: "application/json"
    }), function (response) {
  ...
  return _await$1(fetchJson(compileServerMetaUrl), function (_ref3) {
    ...
    return _invoke$1(function () {
      ...
      return _await$1(createImportResolverForImportmap({
        ...
        var importFile = _async$1(function (specifier) {
          return _await$1(memoizedCreateBrowserSystem({
            compileServerOrigin: compileServerOrigin,
            compileDirectoryRelativeUrl: compileDirectoryRelativeUrl,
            fetchSource: fetchSource,
        ...
        var executeFile = _async$1(function (specifier) {
          ...
          return _await$1(memoizedCreateBrowserSystem({
            ...
            var importUsingSystemJs = _async$1(function () {
              return _catch$1(function () {
                return _await$1(browserSystem.import(specifier), function (namespace) {
                ...
                return _continue(_catch$1(function () {
                  return _await$1(errorTransform(error), function (_errorTransform) {
            ...
            return _await$1(measurePerformance ? measureAsyncFnPerf(importUsingSystemJs, "jsenv_file_import") : importUsingSystemJs(), function (executionResult) {
...
var executeFileUsingDynamicImport = _async(function (specifier) {
  ...
  var fileExecutionResultPromise = _async(function () {
    return _catch(function () {
      ...
      return _await(System.import(url), function (namespace) {
...
//# sourceMappingURL=browser_runtime_59c619c3.js.map