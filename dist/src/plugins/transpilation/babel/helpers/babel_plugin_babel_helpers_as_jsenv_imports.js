...
import { getBabelHelperFileUrl, babelHelperNameFromUrl } from "@jsenv/babel-plugins/main.js"; // named import approach found here:
...
export const babelPluginBabelHelpersAsJsenvImports = (babel, {
  getImportSpecifier
}) => {
  return {
