(function () {
  ...
  var getFeaturesReport = _async$2(function (_ref5) {
    ...
    return jsenvPluginRequiredNames.length > 0 && failFastOnFeatureDetection ? featuresReport : _await$2(supportsImportmap({
